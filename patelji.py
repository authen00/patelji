...
API_TOKEN = '7317976710:AAEOh3zW6bTSBx2Uy0rOAh_vHwI_HFD86jc'
...
'''#By  https://t.me/patel_ji47   ☠️ PATELJI_47☠️:
#@patelji_47
#⠀⠀⠀⣴⣾⣿⣿⣶⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀#
⠀#⠀⠈⢿⣿⣿⣿⣿⠏⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀#⠀⠀⠀⠈⣉⣩⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
async def add_user(message: Message):
    if message.from_user.id!= ADMIN_ID:
        await message.answer("You're not Approved to use this Command DM:-@patelji_47")
        return
...
async def list_users(message: Message):
    if message.from_user.id!= ADMIN_ID:
        await message.answer("You're not Approved to use this Command DM:- @patelji")
        return
    user_list = []
...
async def user_info(message: Message):
    ...
    if user_data:
        ...
        approval_expiry_str = "𝙊𝙥𝙥𝙨 𝙉𝙤𝙩 𝙖𝙥𝙥𝙧𝙤𝙫𝙚𝙙 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 @patelji_47"
...
By  \n\n'''    
                         ...
                         f"𝙀𝙭𝙖𝙢𝙥𝙡𝙚:/patelji 20.235.94.237 17870 180 180\n\n"
                         f"By  https://t.me/patel_ji47 \n\n"
